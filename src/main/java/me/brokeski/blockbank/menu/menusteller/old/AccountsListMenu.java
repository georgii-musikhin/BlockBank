package me.brokeski.blockbank.menu.menusteller.old;
...
public class AccountsListMenu extends Menu {
    ...
    public void handleMenu(InventoryClickEvent e) throws MenuManagerNotSetupException, MenuManagerException {
        ...
        if (e.getCurrentItem().getType() == Material.BARRIER) {
            ...
            if (container.has(new NamespacedKey(BlockBank.getPlugin(), "accountid"), PersistentDataType.INTEGER)){
                playerMenuUtility.setData(MenuData.ACCOUNT_ID, container.get(new NamespacedKey(BlockBank.getPlugin(), "accountid"), PersistentDataType.INTEGER));
    ...
    public void setMenuItems() {
        ...
        accounts.forEach(account -> {
            ...
            PersistentDataContainer container = itemMeta.getPersistentDataContainer();
            container.set(new NamespacedKey(BlockBank.getPlugin(), "accountid"), PersistentDataType.INTEGER, account.getId());
