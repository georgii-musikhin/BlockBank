package me.brokeski.blockbank.menu.menusteller;
    ...
    public void withdrawMoney(double value, Player player) {
        ...
        if (economy.getBalance(player) >= value){
            ...
            if (response.transactionSuccess()){
                ...
                player.sendMessage(MessageUtils.message(BlockBank.getPlugin().getMessageConfig().getTransactionError()));

            }

        }else{
            player.sendMessage(MessageUtils.message(BlockBank.getPlugin().getMessageConfig().getCantAfford()));
        }
    }
}