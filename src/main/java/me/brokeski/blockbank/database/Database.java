...
public class Database {
    ...
    public static ATM getATM(Location location) {
        ...
        try {
            ...
            PreparedStatement statement = getConnection().prepareStatement("SELECT Owner FROM ATM WHERE Location = ?"); statement.setString(1, Serializer.serializeLocation(location));
