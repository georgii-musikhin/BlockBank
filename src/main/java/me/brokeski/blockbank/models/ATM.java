...
public class ATM {
    ...
    public ATM(ItemStack item, Location location) {
        ...
        String uuid = container.get(new NamespacedKey(BlockBank.getPlugin(), "ATMOwner"), PersistentDataType.STRING);
    ...
    public static ItemStack createATM(Player player) {
        ...
        container.set(new NamespacedKey(BlockBank.getPlugin(), "ATMOwner"), PersistentDataType.STRING, player.getUniqueId().toString());
    ...
    public static boolean isValidATM(ItemStack item) {
        ...
        return container.has(new NamespacedKey(BlockBank.getPlugin(), "ATMOwner"), PersistentDataType.STRING);
    }
    ...
    public static boolean isValidATM(Block block) {
        ...
        return container.has(new NamespacedKey(BlockBank.getPlugin(), "atmid"), PersistentDataType.INTEGER);
    }
    ...
    public static int getIdFromBlock(Block block){
        ...
        return container.get(new NamespacedKey(BlockBank.getPlugin(), "atmid"), PersistentDataType.INTEGER);
    }
